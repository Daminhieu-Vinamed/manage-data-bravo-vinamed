    ...
    public function getData()
    {
        ...
        return DataTables::of($collectData)
            ...
            ->addColumn('action', function ($approvalVote) {
                return '<button title="Duyệt đề nghị thanh toán" type="button" class="btn btn-success shadow-sm btn-circle approve-payment-request" branch_code="' . $approvalVote->BranchCode . '" stt="' . $approvalVote->Stt . '"><i class="fas fa-check"></i></button> ' .
                        '<a title="Chỉnh sửa đề nghị thanh toán" class="btn btn-info shadow-sm btn-circle"><i class="fas fa-edit"></i></a> ' .
