...
class UpdateSuggestedPerDiemRequest extends FormRequest
{
    /**
        ...
        $arrValid = array(
            ...
            "DocNo" => [
                ...
                function ($attribute, $value, $fail) {
                    $paymentOrder = DB::connection($this->BranchCode)->table('B33AccDoc')->where("DocCode", $this->DocCode)->where("DocNo", $value)->where("Id","<>", $this->IdSPD)->first();
