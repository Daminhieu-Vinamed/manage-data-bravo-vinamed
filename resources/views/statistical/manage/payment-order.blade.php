        ...
        <div class="col-xl-4 col-lg-6">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="mt-4 text-center small">Tổng: {{ $statistical['countAll'] }} phiếu</div>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-xl-4 col-lg-6">
                <div class="card shadow mb-4">
                    <a href="#collapseCard{{$key}}Bottom" class="d-block card-header py-3" data-toggle="collapse"
                        ...
                        <h6 class="m-0 font-weight-bold text-primary">Đề nghị thanh toán các nhân viên cho {{$key}}</h6>
                    </a>
...
@push('js') 
     ...
     <script src="{{ asset('assets/js/statistical/manage/payment-order.js') }}"></script>
@endpush