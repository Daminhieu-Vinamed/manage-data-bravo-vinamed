...
@section('title', 'Nhập liệu tra cứu tồn')
@section('css')
    ...
    <div class="d-flex justify-content-center">
        <div class="card shadow mb-4" style="width: 60rem">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Nhập liệu tra cứu tồn</h6>
            </div>
            <div class="card-body">
                <form action="{{ route('warehouse.data-look-up-inventory') }}" method="POST">
                    @csrf
                    <div class="row">
...
@push('js')
    ...
    <script src="{{ asset('assets/js/warehouse/look-up-inventory.js') }}"></script>
@endpush