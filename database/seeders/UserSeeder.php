...
class UserSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $data = [
            ...
            ['EmployeeCode' => '345', 'department_code' => 'PURCHASE', 'company' => 'A14', 'username' => 'hieu.trungnguyen', 'name' => 'Nguyễn Trung Hiếu', 'email' => 'hieu.trungnguyen@caotoc24.com', 'password' => bcrypt('abcd@123'), 'status_id' => config('constants.number.one'), 'gender_id' => config('constants.number.one'), 'role_code' => 'ADMIN', 'avatar' => 'assets/images/man.png'],
